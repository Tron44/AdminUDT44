...
<% 
				...
				if (asignaturaSelInt2 != null){
					...
					if (nombreControlSel2 != null){
						...
						out.println("<input type='text' class='form-control' name='nombreC'");
					...
					<% }else{
						out.println("<label>Nombre del control</label><br>");				
						out.println("<input type='text' class='form-control' id='nombreC'");
						...
						out.println("<input type='text' class='form-control' maxlength='100' id='descC'");
